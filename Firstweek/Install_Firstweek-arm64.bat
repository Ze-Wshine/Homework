...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.YourCompany.Firstweek
...
%ADB% %DEVICE% shell pm grant com.YourCompany.Firstweek android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.YourCompany.Firstweek android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
